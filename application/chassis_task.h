...
#define DJ_MOTOR_CHANNEL 4
#define UPDOWN_MOTOR_CHANNEL 4
#define UPDOWN_MOTOR_K 10 //系数
...
#define CHASSIS_ANGLE_Z_RC_SEN 0.000006f
...
//单个底盘电机最大速度
#define MAX_WHEEL_SPEED 6.0//4.0f
...
////底盘旋转跟随PID
//#define CHASSIS_FOLLOW_GIMBAL_PID_KP 38.0f//35
//#define CHASSIS_FOLLOW_GIMBAL_PID_KI 0.0f
//#define CHASSIS_FOLLOW_GIMBAL_PID_KD 60.0f
//#define CHASSIS_FOLLOW_GIMBAL_PID_MAX_OUT 3.5f
//#define CHASSIS_FOLLOW_GIMBAL_PID_MAX_IOUT 0.2f

//chassis follow angle PID
//底盘旋转跟随PID
#define CHASSIS_FOLLOW_GIMBAL_PID_KP 12.0f//35
#define CHASSIS_FOLLOW_GIMBAL_PID_KI 0.0f
#define CHASSIS_FOLLOW_GIMBAL_PID_KD 15.0f
#define CHASSIS_FOLLOW_GIMBAL_PID_MAX_OUT 10000.0f
#define CHASSIS_FOLLOW_GIMBAL_PID_MAX_IOUT 0.2f

#define DJ_MOTOR_SPEED_PID_KP        18.0f
#define DJ_MOTOR_SPEED_PID_KI        1.0f
#define DJ_MOTOR_SPEED_PID_KD        0.0f
#define DJ_MOTOR_SPEED_PID_MAX_OUT   10000.0f
#define DJ_MOTOR_SPEED_PID_MAX_IOUT  10000.0f

#define DJ_MOTOR_ANGLE_PID_KP        0.03f
#define DJ_MOTOR_ANGLE_PID_KI        0.0f
#define DJ_MOTOR_ANGLE_PID_KD        0.005f
#define DJ_MOTOR_ANGLE_PID_MAX_OUT   10000.0f
#define DJ_MOTOR_ANGLE_PID_MAX_IOUT  10000.0f

#define UPDOWN_MOTOR_PID_KP 15.0f
#define UPDOWN_MOTOR_PID_KI 0.1f
#define UPDOWN_MOTOR_PID_KD 0.0f
#define UPDOWN_MOTOR_PID_MAX_OUT 16000.0f
#define UPDOWN_MOTOR_PID_MAX_IOUT 10000.0f
typedef enum
{
...
typedef struct
{
  ...
  pid_type_def chassis_angle_pid;              //follow angle PID.底盘跟随角度pid
	pid_type_def dj_motor_speed_pid; 
  pid_type_def dj_motor_angle_pid;
	  pid_type_def updown_motor_pid;	 
  ...
  fp32 chassis_roll;  //the roll angle calculated by gyro sensor and gimbal motor.陀螺仪和云台电机叠加的roll角度
	  ...
	  int16_t updown_motor_target_speed;
  int16_t updown_motor_current_speed;
  int16_t updown_motor_give_torque;
	
	 int16_t dj_motor_target_speed; 	
	 int16_t dj_motor_current_speed;
	 int16_t dj_motor_give_torque;
	 int32_t dj_motor_angle;
	 int32_t dj_motor_ecd;
} chassis_move_t;
