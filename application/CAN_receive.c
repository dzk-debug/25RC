...
void CAN_cmd_motor(int16_t motor5, int16_t motor6, int16_t motor7, int16_t motor8)
{
    uint32_t send_mail_box;
    ...
    motor_can_send_data[7] = motor8;
	  HAL_CAN_AddTxMessage(&CHASSIS_CAN, &motor_tx_message, motor_can_send_data, &send_mail_box);
