...
void MX_FREERTOS_Init(void) {
  ...
  /* add threads, ... */
		  osThreadStaticDef(Start_INS_Task, INS_Task, osPriorityAboveNormal, 0, 1024, Start_INS_TaskBuffer, &Start_INS_TaskControlBlock);
...
//		  osThreadDef(Start_INS_Task, INS_Task, osPriorityHigh, 0, 1024);
//  Start_INS_TaskHandle = osThreadCreate(osThread(Start_INS_Task), NULL);
